...
public class PostAsyncNoDialog extends AsyncTask<String, Void, String> {
    ...
    public PostAsyncNoDialog(Context context,JSONObject tempJson, CompleteListener listner) {
        mContext = context;
        mtempJson = tempJson;
        mListner = listner;
    }
